...
// function Footer() {
//   return (
//     <footer className="flex flex-col  items-center  w-full md:flex-row md:items-stretch">
//       <div className="w-full  flex flex-col items-center gap-1 md:w-2/3 py-[3rem]">
//         <h3 className="font-logo text-2xl text-green-500">
//           Regency Nepal Travels
//         </h3>
//         <Row>
//           <ImLocation className="text-green-500 text-[1.2rem]" />
//           <p>Hattisar, Kathmandu, Nepal</p>
//         </Row>
//         <Row>
//           <HiMiniPhone className="text-green-500 text-[1.2rem]" />
//           <p>01-4512622, 01-4528818, 01-4512622</p>
//         </Row>
//         <Col>
//           <AiOutlineMail className="text-green-500 text-[1.2rem]" />
//           <p>rnttnepal@gmail.com</p>
//           <p>regencyprashant@gmail.com</p>
//         </Col>
//       </div>
//       <div className="flex flex-col items-center w-full gap-3 py-[2rem] bg-slate-100 md:flex-row md:justify-around">
//         <p>Vacation Type</p>
//         <p>Destinations</p>
//         <Col>
//           <ImWhatsapp className="text-green-500 text-[1.5rem]" />
//           <Col>
//             <p>+977 9767652930</p>
//             <p>+977 9767652933</p>
//             <p>+977 9767652934</p>
//           </Col>
//         </Col>
//         <ImFacebook2 className="text-blue-600 text-[1.5rem]" />
//       </div>
//     </footer>
//   );
// }
