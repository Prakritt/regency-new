...
const Cover = () => (
  <div
    className="relative flex min-h-[72svh] items-center overflow-hidden py-16 sm:min-h-[74svh] lg:min-h-[78svh]"
    style={{
    ...
    <div className="relative mx-auto w-full max-w-7xl px-4 text-white sm:px-6 lg:px-8">
      <div className="max-w-3xl animate-fadeIn">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <StyledNavLink
            to="/tours"
            className="inline-flex min-h-12 items-center justify-center gap-2 rounded-lg bg-green-600 px-5 py-3 text-sm font-semibold text-white transition hover:bg-green-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-300 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
          >
            Explore tours
